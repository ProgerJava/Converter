...
public class ConverterRequest {
    ...
    public String setRequest (String countryName) {

        switch (countryName) {
            case "Австралия": countryName = "AUD"; break; case "Австрия": case "Андорра": case "Бельгия": case "Ватикан":
            case "Германия":
            case "Греция":
            case "Ирландия":
            case "Испания":
            case "Италия":
                countryName = "EUR"; break;
            case "Азербайджан": countryName = "AZN"; break; case "Албания": countryName = "ALL"; break; case "Алжир": countryName = "DZD"; break;
            case "Ангилья":
            case "Гренада":
                countryName = "XCD"; break; case "Ангола": countryName = "AOA"; break; case "Аргентина": countryName = "ARS"; break;
            case "Армения": countryName = "AMD"; break; case "Аруба": countryName = "AWG"; break; case "Афганистан": countryName = "AFN"; break;
            case "Бангладеш": countryName = "BDT"; break; case "Барбадос": countryName = "BBD"; break; case "Бахрейн": countryName = "BHD"; break;
            case "Белоруссия": countryName = "BYN"; break; case "Болгария": countryName = "BGN"; break; case "Боливия": countryName = "BOB"; break;
            case "Бразилия": countryName = "BRL"; break; case "Бутан": countryName = "BTN"; break; case "Вануату": countryName = "VUV"; break;
            case "Великобритания": countryName = "GBP"; break; case "Венгрия": countryName = "HUF"; break; case "Венесуэла": countryName = "VES"; break;
            case "Вьетнам": countryName = "VND"; break; case "Габон": countryName = "XAF"; break; case "Гаити": countryName = "HTG"; break;
            case "Гамбия": countryName = "GMD"; break; case "Гана": countryName = "GHS"; break; case "Гватемала": countryName = "GTQ"; break;
            case "Гвинея": countryName = "GNF"; break; case "Гибралтар": countryName = "GIP"; break; case "Гондурас": countryName = "HNL"; break;
            case "Гонконг": countryName = "HKD"; break; case "Гренландия": countryName = "DKK"; break; case "Грузия": countryName = "GEL"; break;
            case "Дания": countryName = "DKK"; break; case "Доминика": countryName = "XCD"; break; case "Египет": countryName = "EGP"; break;
            case "Замбия": countryName = "ZMW"; break; case "Зимбабве": countryName = "ZWL"; break; case "Израиль": countryName = "ILS"; break;
            case "Индия": countryName = "INR"; break; case "Индонезия": countryName = "IDR"; break; case "Иордания": countryName = "JOD"; break;
            case "Ирак": countryName = "IQD"; break; case "Иран": countryName = "IRR"; break; case "Исландия": countryName = "ISK"; break;
            case "Казахстан": countryName = "KZT"; break; case "Камбоджа": countryName = "KHR"; break; case "Камерун": countryName = "XAF"; break;
            case "Канада": countryName = "CAD"; break; case "США": countryName = "USD"; break; case "Россия": countryName = "RUB"; break;
            case "Украина": countryName = "UAH"; break;
